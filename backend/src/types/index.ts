...
export interface AddBankDTO {
  ...
  ifscCode: string;
  accountHolder: string;
  // balance is NOT accepted from client
}
...
export interface SocketEvents {
  ...
  'limit-updated': (data: { memberId: string; newLimit: number }) => void;
  'payment-received': (data: { amount: number; from: string }) => void;
  typing: (data: { from: string; to: string; isTyping: boolean }) => void;
